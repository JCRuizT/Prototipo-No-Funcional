jQuery("#simulation")
  .on("click", ".s-6f590ccb-98f0-4e91-aacf-317e2e10cfa0 .click", function(event, data) {
  ...
  .on("mouseenter dragenter", ".s-6f590ccb-98f0-4e91-aacf-317e2e10cfa0 .mouseenter", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-6f590ccb-98f0-4e91-aacf-317e2e10cfa0 #s-Rectangle_12 > .backgroundLayer": {
                      "attributes": {
                    ...
                    "#s-6f590ccb-98f0-4e91-aacf-317e2e10cfa0 #s-Rectangle_12": {
                      "attributes-ie": {
  ...
  .on("mouseleave dragleave", ".s-6f590ccb-98f0-4e91-aacf-317e2e10cfa0 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
